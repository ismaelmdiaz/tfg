...
@Component({
  selector: 'app-filtro-arcteryx',
  templateUrl: './filtro-arcteryx.component.html',
  styleUrls: ['./filtro-arcteryx.component.css']
})
export class FiltroArcteryxComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.filtradoPorMarca('Arc-Teryx');
